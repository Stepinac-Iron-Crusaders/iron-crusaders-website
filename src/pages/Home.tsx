...
export default function Home() {
  return (
    <>
          ...
          <div className="grid items-center gap-10 lg:grid-cols-[1.05fr_0.95fr] lg:gap-12">
            <div className="animate-fade-in">
              ...
              <div className="mt-8 flex flex-wrap gap-3">
                <Link
                  to="/team/about"
                  className="inline-flex items-center justify-center bg-red-600 px-8 py-3.5 text-xs font-bold uppercase tracking-[0.14em] text-white transition-all duration-300 hover:-translate-y-1 hover:bg-red-700 hover:shadow-lg focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-white focus-visible:ring-offset-2 focus-visible:ring-offset-zinc-950 active:translate-y-0 active:bg-red-800"
                >
                  Meet the Team
                </Link>
                <Link
                  to="/robots/current"
                  className="inline-flex items-center justify-center border border-blue-600 bg-transparent px-8 py-3.5 text-xs font-bold uppercase tracking-[0.14em] text-white transition-all duration-300 hover:-translate-y-1 hover:bg-blue-600/10 hover:shadow-lg focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-blue-600 focus-visible:ring-offset-2 focus-visible:ring-offset-zinc-950 active:translate-y-0"
                >
                  Our Robot
                </Link>
              </div>
          ...
          <div className="grid items-start gap-10 lg:grid-cols-2 lg:gap-16">
            <div>
              ...
              <div className="mt-6 space-y-4 text-[15px] leading-7 text-zinc-300">
                <p>
                  The Iron Crusaders are the FIRST Robotics Competition team from Archbishop Stepinac High School in White Plains, New York. We unite students, mentors, and alumni around a single mission: learn by building.
                </p>
              ...
              <div className="mt-8 flex gap-3">
                <Link
                  to="/team/about"
                  className="inline-flex items-center gap-2 border border-zinc-700 bg-zinc-950 px-6 py-3 text-xs font-bold uppercase tracking-[0.14em] text-white transition-all duration-300 hover:-translate-y-0.5 hover:border-zinc-600 hover:bg-zinc-900 hover:shadow-md focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-white focus-visible:ring-offset-2 focus-visible:ring-offset-zinc-900 active:translate-y-0"
                >
                  Our Story
                ...
                <a
                  ...
                  target="_blank"
                  rel="noreferrer"
                  className="inline-flex items-center justify-center px-6 py-3 text-xs font-semibold uppercase tracking-[0.14em] text-zinc-400 transition-colors hover:text-white focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-red-600 focus-visible:ring-offset-2 focus-visible:ring-offset-zinc-900"
                >
                  School Website →
                </a>
              </div>
      ...
      <section id="robot" className="border-b border-zinc-800 bg-zinc-950">
        <div className="mx-auto max-w-[1280px] px-4 py-16 lg:px-8 lg:py-20">
          ...
          <div className="grid gap-8 lg:grid-cols-[1.15fr_0.85fr] lg:gap-10">
            <PlaceholderImage label="ROBOT IMAGE PLACEHOLDER" className="aspect-[16/10] lg:aspect-[4/3]" />
                ...
                <div className="grid grid-cols-3 divide-x divide-zinc-800 border-b border-zinc-800">
                  {[
                    ...
                    <div key={s.k} className="px-4 py-3 text-center">
                      ...
                      <div className="mt-1 text-xs font-bold uppercase tracking-wide text-white">{s.v}</div>
                    </div>
                  ))}
                </div>
                ...
                <div className="space-y-6 p-6">
                  <div>
                    <h3 className="flex items-center gap-2 text-xs font-bold uppercase tracking-[0.12em] text-white">
                      <span className="h-1 w-1 bg-red-600" aria-hidden="true" />
                      Drivetrain
                    </h3>
                    <p className="mt-2 text-sm leading-relaxed text-zinc-400">
                      SDS MK4i swerve modules with Kraken X60 drive. Field-oriented control tuned for 16 ft/s with precise pose estimation.
                    </p>
                  </div>
                  <div>
                    <h3 className="flex items-center gap-2 text-xs font-bold uppercase tracking-[0.12em] text-white">
                      <span className="h-1 w-1 bg-blue-600" aria-hidden="true" />
                      Manipulator
                    </h3>
                    <p className="mt-2 text-sm leading-relaxed text-zinc-400">
                      Dual-stage elevator with carbon-fiber arm. Compliant intake for coral and algae — 0.8s acquisition.
                    </p>
                  </div>
                  <div>
                    <h3 className="flex items-center gap-2 text-xs font-bold uppercase tracking-[0.12em] text-white">
                      <span className="h-1 w-1 bg-zinc-500" aria-hidden="true" />
                      Autonomous
                    </h3>
                    <p className="mt-2 text-sm leading-relaxed text-zinc-400">
                      Limelight 3 + PhotonVision. 4-piece auto with on-the-fly path replanning via PathPlanner.
                    </p>
                  </div>
                </div>
              </div>
        ...
        <div className="mx-auto max-w-[1280px] px-4 py-16 lg:px-8 lg:py-20">
          <div className="mx-auto max-w-2xl text-center">
            <div className="mb-3 flex items-center justify-center gap-3">
              ...
              <span className="font-mono text-xs font-semibold uppercase tracking-[0.16em] text-zinc-500">The People</span>
              <span className="h-px w-8 bg-zinc-700" aria-hidden="true" />
            </div>
            <h2 className="text-[28px] font-black uppercase tracking-[-0.02em] text-white sm:text-[36px]">The Team</h2>
          ...
          <div className="mt-10 grid gap-6 md:grid-cols-3">
            {[
              ...
              >
                <div className="flex items-start justify-between">
                  ...
                  >
                    <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.6" aria-hidden="true">
                      {card.title === "Students" && <path d="M16 21v-2a4 4 0 0 0-4-4H6a4 4 0 0 0-4 4v2M9 7a4 4 0 1 0 0 8 4 4 0 0 0 0-8zM22 21v-2a4 4 0 0 0-3-3.87M16 3.13a4 4 0 0 1 0 7.75" />}
                      {card.title === "Mentors" && <path d="M12 12a4 4 0 1 0 0-8 4 4 0 0 0 0 8zM6 20v-2a6 6 0 0 1 12 0v2M16 8l2 2 4-4" />}
                      {card.title === "Leadership" && <path d="M12 15a3 3 0 1 0 0-6 3 3 0 0 0 0 6zM19.4 15a7.5 7.5 0 0 0-14.8 0M12 3v1M12 20v1M4.22 4.22l.7.7M18.36 18.36l.7.7M3 12h1M20 12h1M4.22 19.78l.7-.7M18.36 5.64l.7-.7" />}
                    </svg>
                  </div>
                ...
                <Link
                  to={card.to}
                  className="mt-4 inline-flex text-xs font-semibold uppercase tracking-[0.1em] text-zinc-300 transition-colors group-hover:text-white focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-red-600 focus-visible:ring-offset-2 focus-visible:ring-offset-zinc-950"
                >
                  View {card.title}
        ...
        <div className="mx-auto max-w-[1280px] px-4 py-16 lg:px-8 lg:py-20">
          <div className="flex flex-wrap items-end justify-between gap-6">
            <div>
              <div className="mb-3 flex items-center gap-3">
                <span className="h-px w-8 bg-red-600" aria-hidden="true" />
                <span className="font-mono text-xs font-semibold uppercase tracking-[0.16em] text-red-500">Why We Build</span>
              </div>
          ...
          <div className="mt-10 grid gap-4 sm:grid-cols-2 lg:grid-cols-3">
            {[
              { title: "Engineering", desc: "Rigorous design, tolerancing, and iteration. We measure twice, cut once — then test to failure.", icon: "M14.5 2a2.5 2.5 0 0 0 0 5 2.5 2.5 0 0 0 0 5 2.5 2.5 0 1 0 0 5M9.5 2a2.5 2.5 0 0 1 0 5 2.5 2.5 0 0 1 0 5A2.5 2.5 0 1 1 9.5 17", hover: "hover:border-red-600/40" },
              { title: "STEM", desc: "Real tools, real code, real physics. From CAD to controls — students ship production systems.", icon: "M9 3H5a2 2 0 0 0-2 2v14a2 2 0 0 0 2 2h14a2 2 0 0 0 2-2v-4M9 3a2 2 0 0 1 2-2h2a2 2 0 0 1 2 2v2a2 2 0 0 1-2 2h-2a2 2 0 0 1-2-2V3z", hover: "hover:border-blue-600/40" },
              { title: "Leadership", desc: "Ownership, accountability, and clear communication when pressure is highest.", icon: "M12 15a3 3 0 1 0 0-6 3 3 0 0 0 0 6zM19.4 15a7.5 7.5 0 0 0-14.8 0M12 3v1M12 20v1", hover: "hover:border-red-600/40" },
              { title: "Collaboration", desc: "Mechanical, electrical, and software — one team, one robot, one pit crew.", icon: "M16 21v-2a4 4 0 0 0-4-4H6a4 4 0 0 0-4 4v2M9 7a4 4 0 1 0 0 8 4 4 0 0 0 0-8zM22 21v-2a4 4 0 0 0-3-3.87", hover: "hover:border-blue-600/40" },
              { title: "Innovation", desc: "Prototype fast, validate faster. We chase 1% gains that win matches.", icon: "M12 2a7 7 0 0 0-7 7c0 3.5 3 6.5 7 10 4-3.5 7-6.5 7-10a7 7 0 0 0-7-7zM12 12a2.5 2.5 0 1 0 0-5 2.5 2.5 0 0 0 0 5z", hover: "hover:border-red-600/40" },
              { title: "Community", desc: "We teach what we learn — hosting workshops, demos, and STEM nights across Westchester.", icon: "M17 21v-2a4 4 0 0 0-4-4H5a4 4 0 0 0-4 4v2M9 7a4 4 0 1 0 0 8 4 4 0 0 0 0-8zM23 21v-2a4 4 0 0 0-3-3.87M16 3.13a4 4 0 0 1 0 7.75", hover: "hover:border-blue-600/40" },
            ].map((card) => (
              <div
                key={card.title}
                className={`border border-zinc-800 bg-zinc-900 p-6 transition-colors duration-300 ${card.hover} hover:bg-zinc-900`}
              >
                ...
                <h3 className="mt-4 text-xs font-black uppercase tracking-[0.12em] text-white">{card.title}</h3>
                <p className="mt-2 text-sm leading-relaxed text-zinc-400">{card.desc}</p>
              </div>
            ))}
          </div>
        ...
        <div className="mx-auto max-w-[1280px] px-4 py-16 lg:px-8 lg:py-20">
          <div className="mb-10 flex flex-wrap items-end justify-between gap-6">
            <div>
              ...
              <h2 className="text-[28px] font-black uppercase tracking-[-0.02em] text-white sm:text-[36px]">Outreach</h2>
              <p className="mt-3 max-w-[48ch] text-sm leading-relaxed text-zinc-400">
                We bring robotics to the community — demos, workshops, and mentorship that make STEM tangible.
              </p>
            </div>
            <Link
              to="/outreach"
              className="hidden items-center gap-2 border border-zinc-700 bg-zinc-950 px-5 py-2.5 text-xs font-bold uppercase tracking-[0.12em] text-white transition-colors hover:border-zinc-600 hover:bg-zinc-900 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-white focus-visible:ring-offset-2 focus-visible:ring-offset-zinc-900 sm:inline-flex"
            >
              View All Outreach
          ...
          <div className="grid gap-6 md:grid-cols-3">
            {[
              { label: "OUTREACH — SCHOOL DEMO PLACEHOLDER", title: "School Demos", desc: "Live robot demos and Q&A for elementary and middle schools." },
              { label: "OUTREACH — COMMUNITY WORKSHOP PLACEHOLDER", title: "Community Workshops", desc: "Hands-on build nights — wiring, CAD, and programming for beginners." },
              { label: "OUTREACH — STEM NIGHT PLACEHOLDER", title: "STEM Nights", desc: "Evening events with families, faculty, and local industry partners." },
            ].map((card) => (
              <div key={card.title} className="group border border-zinc-800 bg-zinc-950">
                <PlaceholderImage label={card.label} className="aspect-[4/3] rounded-none border-0 border-b border-zinc-800" />
                <div className="p-5">
                  <h3 className="text-sm font-bold uppercase tracking-wide text-white">{card.title}</h3>
                  <p className="mt-2 text-sm leading-relaxed text-zinc-400">{card.desc}</p>
                  <Link
                    to="/outreach"
                    className="mt-4 inline-flex text-xs font-semibold uppercase tracking-[0.1em] text-zinc-400 transition-colors hover:text-white focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-red-600"
                  >
                    Learn more →
                  </Link>
                </div>
          ...
          <div className="mt-6 flex justify-center sm:hidden">
            ...
            >
              View All Outreach <span aria-hidden="true">→</span>
            </Link>
          </div>
        </div>
      </section>
      ...
      {/* ===================================== 7. ACHIEVEMENTS ===================================== */}
      <section className="relative overflow-hidden border-y border-zinc-800 bg-zinc-950" aria-label="Achievements">
        <div
          aria-hidden="true"
        ...
        <div className="relative mx-auto max-w-[1280px] px-4 py-12 lg:px-8 lg:py-14">
          <div className="grid gap-8 divide-zinc-800 sm:grid-cols-2 lg:grid-cols-4 lg:divide-x">
            {[
              { value: STATS.students, label: "Students", sub: "Active roster" },
              { value: STATS.awards, label: "Awards", sub: "Regional & district" },
              { value: STATS.competitions, label: "Competitions", sub: "FRC events" },
              { value: STATS.founded, label: "Founded", sub: "White Plains, NY" },
            ].map((stat) => (
      ...
      <section id="sponsors" className="border-b border-zinc-800 bg-zinc-900">
        <div className="mx-auto max-w-[1280px] px-4 py-16 lg:px-8 lg:py-20">
          <div className="mx-auto max-w-2xl text-center">
            ...
            <p className="mt-3 text-sm leading-relaxed text-zinc-400">
              Industry and community partners who make our season possible — from materials and machining to travel and outreach.
            </p>
          </div>
          ...
          <div className="mt-10 flex flex-col items-center gap-4 border-t border-zinc-800 pt-10">
            ...
            <Link
              to="/sponsors"
              className="inline-flex items-center justify-center bg-red-600 px-8 py-3.5 text-xs font-bold uppercase tracking-[0.14em] text-white transition-all duration-300 hover:-translate-y-1 hover:bg-red-700 hover:shadow-lg focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-white focus-visible:ring-offset-2 focus-visible:ring-offset-zinc-900 active:translate-y-0 active:bg-red-800"
            >
              Become a Sponsor
            </Link>
        ...
        <div className="mx-auto max-w-[1280px] px-4 py-16 lg:px-8 lg:py-20">
          <div className="mb-10 flex flex-wrap items-end justify-between gap-6">
            <div>
              ...
              <h2 className="text-[28px] font-black uppercase tracking-[-0.02em] text-white sm:text-[36px]">Latest News</h2>
            </div>
            <Link
              to="/media"
              className="hidden text-xs font-semibold uppercase tracking-[0.12em] text-zinc-400 transition-colors hover:text-white focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-red-600 sm:inline-flex"
            >
              View all posts →
            </Link>
          </div>
          ...
          <div className="grid gap-6 md:grid-cols-3">
            {[
              { date: "Aug 28, 2026", title: "Kickoff Countdown: Build Season Prep Underway", excerpt: "Inventory, strategy binders, and swerve calibration — how we’re starting strong for Reefscape.", tag: "Build Season" },
              { date: "Aug 15, 2026", title: "Alumni Spotlight: From Pit Crew to Mechanical Engineer", excerpt: "A Stepinac graduate reflects on how FRC shaped a career in aerospace manufacturing.", tag: "Alumni" },
              { date: "Aug 02, 2026", title: "Community Demo Day Draws 200+ Future Engineers", excerpt: "Live demos, mini-bot driving, and a packed Q&A — outreach by the numbers.", tag: "Outreach" },
            ].map((post) => (
              <article
                key={post.title}
              ...
              >
                <PlaceholderImage label="NEWS IMAGE PLACEHOLDER" className="aspect-[16/9] rounded-none border-0 border-b border-zinc-800" />
                <div className="flex flex-1 flex-col p-6">
                  ...
                  <Link
                    to="/media"
                    className="mt-4 inline-flex text-xs font-semibold uppercase tracking-[0.1em] text-zinc-300 transition-colors hover:text-white focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-red-600"
                  >
                    Read article →
                  </Link>
                </div>
          ...
          <div className="mt-6 flex justify-center md:hidden">
            <Link to="/media" className="text-xs font-semibold uppercase tracking-[0.12em] text-zinc-400 hover:text-white">
              View all posts →
            </Link>
          </div>
        </div>
      ...
      {/* ===================================== 10. FINAL CTA ===================================== */}
      <section className="relative overflow-hidden bg-red-600" aria-label="Call to action">
        <div
          aria-hidden="true"
        ...
        <div className="relative mx-auto max-w-[1280px] px-4 py-12 lg:px-8 lg:py-14">
          <div className="flex flex-col items-center justify-between gap-6 lg:flex-row lg:gap-10">
            ...
            <div className="flex shrink-0 flex-col items-center gap-3 sm:flex-row">
              <Link
                to="/sponsors"
                className="inline-flex items-center justify-center bg-white px-8 py-4 text-xs font-black uppercase tracking-[0.14em] text-red-600 transition-all duration-300 hover:-translate-y-0.5 hover:bg-zinc-100 hover:shadow-xl focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-white focus-visible:ring-offset-2 focus-visible:ring-offset-red-600 active:translate-y-0"
              >
                Sponsor Us
              </Link>
              <span className="hidden font-mono text-xs uppercase tracking-wide text-red-100 sm:inline">Tax-deductible • Contact us today</span>
            </div>
          </div>
        </div>
      </section>
