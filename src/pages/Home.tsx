    ...
    <>
                ...
                <div className="flex items-start justify-between">
                  ...
                  >
                    <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.6" aria-hidden="true">
                      ...
                      {card.title === "Leadership" && <path d="M12 15a3 3 0 1 0 0-6 3 3 0 0 0 0 6zM19.4 15a7.5 7.5 0 0 0-14.8 0M12 3v1M12 20v1M4.22 4.22l.7.7M18.36 18.36l.7.7M3 12h1M20 12h1" />}
                    </svg>
                  </div>
      ...
      <section className="border-b border-zinc-800 bg-zinc-950">
        <div className="mx-auto max-w-[1280px] px-4 py-16 lg:px-8 lg:py-20">
          ...
          <div className="mt-10 grid gap-4 sm:grid-cols-2 lg:grid-cols-3">
            {[
              { title: "Engineering", desc: "Rigorous design, tolerancing, and iteration. We measure twice, cut once — then test to failure.", icon: "M14.5 2a2.5 2.5 0 0 0 0 5 2.5 2.5 0 0 0 0 5" },
              { title: "STEM", desc: "Real tools, real code, real physics. From CAD to controls — students ship production systems.", icon: "M9 3H5a2 2 0 0 0-2 2v14a2 2 0 0 0 2 2h14a2 2 0 0 0 2" },
              { title: "Leadership", desc: "Ownership, accountability, and clear communication when pressure is highest.", icon: "M12 15a3 3 0 1 0 0-6 3 3 0 0 0 0 6zM19.4 15a7.5 7.5 0 0 0-14.8 0" },
              { title: "Collaboration", desc: "Mechanical, electrical, and software — one team, one robot, one pit crew.", icon: "M16 21v-2a4 4 0 0 0-4-4H6a4 4 0 0 0-4 4v2M9 7a4 4 0 1 0 0 8" },
              { title: "Innovation", desc: "Prototype fast, validate faster. We chase 1% gains that win matches.", icon: "M12 2a7 7 0 0 0-7 7c0 3.5 3 6.5 7 10" },
              { title: "Community", desc: "We teach what we learn — hosting workshops, demos, and STEM nights across Westchester.", icon: "M17 21v-2a4 4 0 0 0-4-4H5a4 4 0 0 0-4 4v2" },
            ].map((card) => (
              <div
                key={card.title}
      ...
      <section className="border-b border-zinc-800 bg-zinc-950">
        <div className="mx-auto max-w-[1280px] px-4 py-16 lg:px-8 lg:py-20">
          ...
          <div className="grid gap-6 md:grid-cols-3">
            {[
              { date: "Aug 28, 2026", title: "Kickoff Countdown: Build Season Prep Underway", excerpt: "Inventory, strategy binders, and swerve calibration — how we’re starting strong for Reefscape season.", tag: "Build" },
